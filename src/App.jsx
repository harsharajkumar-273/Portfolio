...
export default function App() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <footer className="wrap"><div><p className="eyebrow">LET’S CONNECT</p><h2>Have a backend or platform<br/>role for a 2027 graduate?</h2><a className="contact-email" href="mailto:harsha.raj.kumar@vanderbilt.edu">harsha.raj.kumar@vanderbilt.edu <ArrowUpRight size={21}/></a></div><div className="footer-links"><External href={github}>GitHub</External><External href="https://linkedin.com/in/harsharajkumar273">LinkedIn</External><span>Nashville, TN · Open to relocation</span></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Harsha Raj Kumar</span><a href="#about">Back to top ↑</a></div></footer>
